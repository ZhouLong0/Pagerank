...
class Node:
    ...
    def __str__(self):
        ...
        """
        # add your code here
        s = 'Node ' + '[' + str(self.__identifier) + ']' + '\n'
        for i in (sorted(self.__attributes.keys())):
            s += '    ' + str(i) + ' : ' + str(self.__attributes[i]) + '\n'
        return s
...
class Edge:
    ...
    def nodes(self):
        ...
        """
        # add your code here
        return tuple((self.__node1, self.__node2))
    ...
    def __str__(self):
        ...
        for i in (sorted(self.__attributes.keys())):
            s += '    ' + str(i) + ' : ' + str(self.__attributes[i]) + '\n'
        return 'Edge from node [' + str(self.__node1.identifier()) + '] to node [' + str(self.__node2.identifier()) + ']\n' + s
    
    def __eq__(self, __o: object) -> bool:
        """Two edges are equals if the leaving and arriving nodes are the same
...
class BaseGraph:
    ...
    def add_edge(self, node1_id, node2_id, **attributes):
        ...
        """
        # add your code here
        n1, n2 = self.node(node1_id), self.node(node2_id)
    ...
    def __contains__(self, item):
        ...
        if isinstance(item, tuple):
            e1 = Edge(Node(item[0]), Node(item[1]))
            return e1 in self.__edges 
...
class UndirectedGraph(BaseGraph):
    ...
    def add_edge(self, node1_id, node2_id, **attributes):
        if node1_id == node2_id: raise GraphError()
